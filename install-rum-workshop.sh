...
BACKEND_FILE='install-rum-prerequisites.sh'
...
NEWUSER="d1prumworkshop"                
NEWPWD="dynatrace"
        
FUNCTIONS_FILE_REPO="https://raw.githubusercontent.com/nikhilgoenkatech/RUMD1Workshops/master/install-rum-prerequisites.sh"
...
if [ -f "$BACKEND_FILE" ]; then
    ...
    curl -o install-rum-prerequisites.sh $FUNCTIONS_FILE_REPO
fi
